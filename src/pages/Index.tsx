  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0,0,0,0.35), rgba(0,0,0,0.45)), url('https://cdn.poehali.dev/projects/d5d74ee8-8a30-4bf4-8d56-81221a90a86c/files/582bbc95-4602-49e3-b5e1-96ad361c668a.jpg')`,
        }}
      >
